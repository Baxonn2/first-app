...
@section('content')
    ...
    <div class="alert alert-success alert-dismissible fade show" role="alert">
        <strong> Listo. </strong> {{ session()->get('flash') }}
                ...
                <div class="col-lg-6">
                    ...
                    <form id="contact-form" method="post" action="{{ route('message') }}" role="form">
                        ...
                        <div class="form-group">
                            <input id="form-name" name="form-name" class="form-control form-control-lg" type="text" placeholder="Your name" required>
                        </div>
                        <div class="form-group">
                            <input id="form-email" name="form-email" class="form-control form-control-lg" type="email" placeholder="email@example.com" required>
                        </div>
                        <div class="form-group">
                            <input id="form-phone" name="form-phone" class="form-control form-control-lg" type="text" placeholder="+40-745-234-567" required>
                        </div>
                        <div class="form-group">
                            <textarea id="form-message" name="form-message" class="form-control form-control-lg" placeholder="Tell us a few words ..." rows="3" required></textarea>
                        </div>
